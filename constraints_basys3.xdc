...
## Switches
set_property PACKAGE_PIN V17 [get_ports {clk_enable}]					
...
#set_property PACKAGE_PIN T1 [get_ports {clk_enable}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {clk_enable}]
...
#set_property PACKAGE_PIN E19 [get_ports {clk_enable}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {clk_enable}]
...
#set_property PACKAGE_PIN P1 [get_ports {clk_enable}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {clk_enable}]
...
##Sch name = JB7
#set_property PACKAGE_PIN A15 [get_ports {DIN}]					
...
##Pmod Header JC
#Sch name = JC1
#set_property PACKAGE_PIN K17 [get_ports {nsync}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {nsync}]
##Sch name = JC2
#set_property PACKAGE_PIN M18 [get_ports {d1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {d1}]
##Sch name = JC3
#set_property PACKAGE_PIN N17 [get_ports {d2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {d2}]
##Sch name = JC4
